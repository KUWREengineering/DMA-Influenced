...
decision_time      = '23:00'
number_hours       = 4
pumping_station    = ['RATBURANA_RAMA2','RATBURANA_YAIROM']
...
for col in head_per_loop.columns:
    ...
    head_per_loop[col] = head_per_loop[col].str.replace("]", "")
    head_per_loop[col] = head_per_loop[col].str.split(" ",expand=True).astype(float).mean(axis=1)
